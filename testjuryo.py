...
# Excelファイルの場所
excel_file = r'C:\Users\DSP189\Desktop\新しいフォルダー (3)\\工場別月末端材重量(copy).xlsx'
...
# Đọc giá trị của row từ tập tin
row = doc_gia_tri()


# Gọi hàm tang_row để tăng giá trị của row
row = tang_row(row)


# Lưu giá trị mới của row vào tập tin
luu_gia_tri(row)
